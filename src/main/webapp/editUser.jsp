	            ...
	            <div class="col-md-8">
	                <div class="card">
						...
						%>
	                        ...
	                        <form  action="editUser" method="post" id="sample_form" enctype="multipart/form-data"  onsubmit="return checkDetails();">
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <input type="text" id="address" class="form-control" name="address" value="<%=user.getAddress() %>" required>
	                                </div>
	                            </div>
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <input type="email" id="email" class="form-control" name="email" value="<%=user.getEmail() %>" required>
	                                </div>
	                            </div>
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <input type="text" id="nic" class="form-control" name="nic" value="<%=user.getNic() %>" required>
	                                </div>
	                            </div>
		                        ...
		                        <div class="form-group row">
		                            ...
		                            <div class="col-md-6">
		                                ...
		                                <input type="hidden" id="imagePath" name="photo" value="<%=user.getPhoto() %>" >
		                            </div>
		                        </div>
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <input type="password" id="cpassword" class="form-control" name="cpassword" value="<%=user.getPassword() %>" required>
	                                </div>
	                            </div>
