	        ...
	        <div class="row justify-content-center">
	            <div class="col-md-8">
	                <div class="card">
						...
						%>
	                        <form action="editDriver" method="post" id="sample_form" enctype="multipart/form-data">
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <input type="text" id="name" class="form-control" name="name" value="<%=driver.getName() %>" required>
	                                </div>
	                            </div>
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <input type="number" id="age" class="form-control" name="age" value="<%=driver.getAge() %>" required>
	                                </div>
	                            </div>
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <input type="text" id="nic" class="form-control" name="nic" value="<%=driver.getNic() %>" required>
	                                </div>
	                            </div>
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <input type="text" id="address" class="form-control" name="address" value="<%=driver.getAddress() %>" required>
	                                </div>
	                            </div>
		                        ...
		                        <div class="form-group row">
		                            ...
		                            <div class="col-md-6">
		                                ...
		                                <input type="hidden" id="imagePath" name="photo" value="<%=driver.getPhoto() %>" >
		                            </div>
		                        </div>
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                    <input type="number" id="years" class="form-control" name="years" value="<%=driver.getYears() %>" required>
	                                    <img src="<%=driver.getPhoto() %>" width='70' class='img-thumbnail' />
	                                </div>
	                            </div>
